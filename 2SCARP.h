...
void nombre_femenino1(char cadena[])
{
    char PriNomFem[10][10] = {"MARIA", "ANA", "LAURA", "ISABEL", "CARMEN", "MARTHA", "PATRICIA", "TERESA", "ELENA", "ROSA"};
    strcpy(cadena, PriNomFem[rand()%10]);
}

void nombre_femenino2(char cadena[])
{
    char SegNomFem[10][15] = {"BEATRIZ", "DANNA", "SARA", "SOFIA", "LUCIA", "ALONDRA", "GABRIELA", "CARLA", "ANA", "PAULA"};
    strcpy(cadena, SegNomFem[rand()%10]);
}

void nombre_masculino1(char cadena[])
{
    char PriNomMas[10][10] = {"JUAN", "MANUEL", "LUIS", "CARLOS", "ALEJANDRO", "EDUARDO", "SAUL", "JAVIER", "MIGUEL", "ALBERTO"};
    strcpy(cadena, PriNomMas[rand()%10]);
}

void nombre_masculino2(char cadena[])
{
    char SegNomMas[10][10] = {"SERGIO", "JOSE", "FRANCISCO", "ANDRES", "GABRIEL", "GUILLERMO", "RAUL", "ADRIAN", "RICARDO", "VICTOR"};
    strcpy(cadena, SegNomMas[rand()%10]);
}

void apellidos(char cadena[])
{
    char Apellido1[20][10] = {"RODRIGUEZ", "PEREZ", "GONZALES", "MENESES", "VILLEGAS", "VARGAS", "ESCOBAR", "VAZQUEZ", "MORALES", "ORTEGA", "MENDOZA", "SILVA", "JIMENEZ", "DIAZ", "HERRERA", "SOTO", "ESPINOZA", "LOPEZ", "PALACIO", "TORRES"};
...
void estados_republica(char estados[][30])
{
    ...
    strcpy(estados[32], "Es nacido en el Extranjero");
}
