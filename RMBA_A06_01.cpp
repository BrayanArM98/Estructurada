...
void menu()
{
    ...
    printf("7. Digitos con ciclo for\n");
    printf("8. Digitos con ciclo while\n");
    printf("9. Digitos con ciclo do while\n");
    scanf("%d", &op);
...
void forfibo()
{
    ...
    printf("\n Ingrese el numero de veces que quiere que se repita el ciclo: ");
    scanf("%d", &n);
...
void whifibo()
{
    ...
    printf("\n Ingresa el numero de veces que quiere que se repita el ciclo: ");
    scanf("%d", &n);
...
void whifacto()
{
    ...
    printf("Ingrese un numero del factorial: ");
    scanf("%d", &n);
